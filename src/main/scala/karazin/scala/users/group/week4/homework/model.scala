...
import karazin.scala.users.group.week4.homework.errors.DomainError
...
object model:
  ...
  case class RegistrationData(username: String, password: String, email: String, age: Int, phone: String)
