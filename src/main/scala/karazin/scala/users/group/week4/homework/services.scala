...
object services:
  ...
  // Emulation
  def registerUser(username: String, password: String, email: String, age: Int, phone: String)
    ...
    EitherT[Future, DomainErrors, UserProfile](
      Future {
        ...
        */
        ...
        validation.validateRegistrationForm(username, password, email, age, phone)/*In a case of success store the user in the db*/
