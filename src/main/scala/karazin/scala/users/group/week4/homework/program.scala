...
object program extends App:
  ...
  def registrationFlow(username: String, password: String, email: String, age: Int, phone: String)
                      (using ExecutionContext): Result[UserProfile] =
    for
      registrationResult <- registerUser(username, password, email, age, phone)
